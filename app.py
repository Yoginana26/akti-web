...
# Daftar Nama Mahasiswa AKTI Sesuai Data Gambar Terbaru (Sudah Dikoreksi)
MAHASISWA_LIST = [
    ...
    'LUTFHY ASROFUL ANAM', 'M. RAFFA ZEIN', 'M. RASSYA ADZIKRA', 'MADAHAYA BISMA PUTRA NUR ISTANTO',
