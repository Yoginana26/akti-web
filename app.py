...
# Daftar Lengkap Nama Mahasiswa AKTI Sesuai Spreadsheet
MAHASISWA_LIST = [
    ...
    'JAFFAR AS SIDHIQ', 'JAVARA FIRZI NURFAIDHILAH', 'KINANTI DWI PUTRI', 'ALISA PUTRIANI',
    'LUTFHY ASROFUL ANAM', 'M. RAFFA ZEIN', 'M. RASSYA ADZIKRAMA', 'HADAYA BISMA PUTRA NUR ISTANTO',
    ...
    'SINDI YANITA', 'RUNA', 'TEGGAR RAMADHAN', 'TRI SETYANI ANINDITA', 'USAMAH', 'VAREL MAULANA',
        ...
        if selected_nama == "- Pilih Nama Mahasiswa -":
            ...
            with st.spinner("⏳ Menghitung nilai konversi & mengirim ke spreadsheet..."):
                try:
                    ...
                    # Mengirim hasil nilai konversi yang sudah matang ke Apps Script
                    payload = {
                        "nama": selected_nama,
                        "tb": input_tb,
                        "bb": input_bb,
